 ...
 */
export const EXTENSION_ID: string = 'pythonGenerator';
 ...
 */
export const EXTENSION_NAME: string = 'vscode-python-generator';
 ...
 */
export const EXTENSION_DISPLAY_NAME: string = 'Python File Generator';
 ...
 *
 * @returns {'py'} - The default file extension of the extension
 */
export const DEFAULT_FILE_EXTENSION: 'py' = 'py';
...
/**
 * ContentTemplate: The custom template descriptor.
 * @interface
 * @public
 * @memberof Constants
...
export interface ContentTemplate {
  ...
  subcategory?: 'api' | 'domain' | 'data' | 'cli' | 'testing' | 'logging';
  tags?: string[];
  ...
  usage?: 'common' | 'occasional' | 'advanced';
  recommended?: boolean;
  template: string[];
}
